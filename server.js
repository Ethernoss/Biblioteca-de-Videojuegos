...
// Stripe setup
const stripe = require("stripe")("sk_test_51QPCNnGAB1NMfz0pEaLpkGnWmhoeg9texZClV5m8cqjpqe5TkJtX2uK0LjYftfI3n5bM0gZdet09ugAho16i8mjc00jdPHsbgZ");
...
app.get("/session-status", async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: "Error al recuperar el estado de la sesión" });
  }
});
